        ...
        while(true)
        {
            ...
            if(key.equals("cartoon")||key.equals("thriller")||key.equals("soapOpera")){
                if (key.equals("cartoon")) {
                   Movie movieC = MovieFactory.getMovie("cartoon");
                    System.out.println( movieC.getClass().getSimpleName());
                 }
                if (key.equals("thriller")) {
                    Movie movieT = MovieFactory.getMovie("thriller");
                    System.out.println( movieT.getClass().getSimpleName());
                }
                if (key.equals("soapOpera")) {
                    Movie movieSO = MovieFactory.getMovie("soapOpera");
                    System.out.println( movieSO.getClass().getSimpleName());
                }
