...
2.1. Создать соответствующий объект [см Person.java], например, для строки "user" нужно создать
объект класса User.
...
public class Solution
{
    public static void main(String[] args) throws Exception
    {
        ...
        while(true)
        {
            ...
            key = reader.readLine();
          if(key.equals("coder")||key.equals("proger")||key.equals("user")||key.equals("looser")){
