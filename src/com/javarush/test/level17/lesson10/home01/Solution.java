...
/* Общий список
1. Изменить класс Solution так, чтобы он стал списком. (Необходимо реализовать интерфейс
java.util.List).
...
public class Solution implements List<Long> {
   ...
   /* @Override
    public synchronized void sort(Comparator<? super Long> c) { // убейте его и ещё смотри ниже
        original.sort(c);
    }*/
    @Override
   ...
   /* @Override
    public synchronized Spliterator<Long> spliterator() {  // и его
