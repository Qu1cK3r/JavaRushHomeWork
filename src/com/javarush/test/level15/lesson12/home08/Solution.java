...
public class Solution {
    public static void main(String[] args) {
        new B(6);       //т.к создается метод В, то и метод initialize будет вызываться из В
    }                   //переопределенным. Если сменить модификатор доступа, то А не знает о
                        // не знает о initialize в В, и вызывает свой
